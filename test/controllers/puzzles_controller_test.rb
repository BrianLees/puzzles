...
class PuzzlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create puzzle" do
    assert_difference('Puzzle.count') do
      post puzzles_url, params: { puzzle: { default_size: @puzzle.default_size, file_name: @puzzle.file_name, name: @puzzle.name } }
    end
  ...
  test "should update puzzle" do
    patch puzzle_url(@puzzle), params: { puzzle: { default_size: @puzzle.default_size, file_name: @puzzle.file_name, name: @puzzle.name } }
